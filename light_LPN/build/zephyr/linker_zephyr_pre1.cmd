 ...
 *(".kernel.*")
 ...
 bt_mesh_ext_adv_area : ALIGN_WITH_INPUT SUBALIGN(4) { _bt_mesh_ext_adv_list_start = .; KEEP(*(SORT_BY_NAME(._bt_mesh_ext_adv.static.*))); _bt_mesh_ext_adv_list_end = .; } > RAM AT > FLASH
