...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_EXT_ADV_MAX_ADV_SET, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_FRIEND_RECV_WIN, 25);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_FRIEND_LPN_COUNT, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_SET, 10);
