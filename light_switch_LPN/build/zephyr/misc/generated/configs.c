...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_NODE_ID_TIMEOUT, 30);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_LPN_AUTO_TIMEOUT, 15);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_LPN_POLL_TIMEOUT, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_LPN_INIT_POLL_TIMEOUT, 100);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EI_WRAPPER_DATA_BUF_SIZE, 600);
